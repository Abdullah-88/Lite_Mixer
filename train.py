...
from litemixer import LiteMixer
...
class LiteMixerImageClassification(LiteMixer):
    def __init__(
        self,
        image_size=32,
        patch_size=4,
...
model = LiteMixerImageClassification().to(device)
print(model)
...
logname = "/PATH/Lite_Mixer/Experiments_cifar10/logs_litemixer/logs_cifar10.csv"
...
path = "/PATH/Lite_Mixer/Experiments_cifar10/weights_litemixer"
model_name = "LiteMixerImageClassification_cifar10"
